...
@Module({
  ...
  providers: [CustomerContextService, ActivationGuardService, EventProjectionService, SuppressionService],
  exports: [CustomerContextService, ActivationGuardService, EventProjectionService, SuppressionService],
})
